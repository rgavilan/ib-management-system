...
public class PojoGeneralLinkListener {
     ...
     * @param message
     */
    @KafkaListener(topics = "#{'${app.kafka.general-link-topic-name}'.split(',')}", containerFactory = "pojoLinkKafkaListenerContainerFactory", properties = {"spring.json.value.default.type:es.um.asio.domain.PojoLinkData"})
