...
public class RDFCvnBuilderServiceTest {
	...
	@Test
	public void whenCreateResourceOf_SimpleCvnBeanResource_thenGenerateRdf()
		...
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#foo")
				.withValue("foo value");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code").withValue("00001");
	}

	@Test
	public void whenCreateResourceOf_SimpleCvnBeanWithEmptyAndNullProperties_thenGenerateRdf()
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		SimpleCvnBeanDummy simpleCvnBean = new SimpleCvnBeanDummy();
		simpleCvnBean.setCode("");
		simpleCvnBean.setFoo(null);

		Model model = rdfCvnBuilderService.createRDF(simpleCvnBean).getModel();

		ModelAssert.assertThat(model).hasStatementsSize(2);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code")
				.withValue(StringUtils.EMPTY);
		ModelAssert.assertThat(model).noContainsPredicate("http://www.w3.org/2001/asio-rdf/3.0#foo");
	}

	@Test
	public void whenCreateResourceOf_ComplexCvnBean_thenGenerateRdf()
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		// Arrange
		SimpleCvnBeanDummy simpleCvnBean = new SimpleCvnBeanDummy();
		...
		Model model = rdfCvnBuilderService.createRDF(complexCvnBean).getModel();

		// Assert
		ModelAssert.assertThat(model).hasStatementsSize(6);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#simpleCvnBean")
				.withBlankNodeValue();
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#foo")
				.withBlankNodeSubject().withValue("foo value");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code")
				.withBlankNodeSubject().withValue("00002");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#bar")
				.withValue("bar value");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code").withValue("00001");
	...
	@Test
	public void whenCreateResourceOf_CvnBeanWithInheritance_thenGenerateRdf()
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		...
		Model model = rdfCvnBuilderService.createRDF(childCvnBean).getModel();

		ModelAssert.assertThat(model).hasStatementsSize(4);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code").withValue("00001");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#parent")
				.withValue("parent value");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#child")
				.withValue("child value");
	}

	@Test
	public void whenCreateResourceOf_CvnBeanWithCollectionOfSimpleCvnBean_thenGenerateRdf()
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		// Arrange
		...
		Model model = rdfCvnBuilderService.createRDF(cvnBeanWithCvnBeanCollection).getModel();

		// Assert
		ModelAssert.assertThat(model).hasStatementsSize(10);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code").withValue("00003");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#simpleCvnBeans")
				.withBlankNodeValue().hasStatementsSize(3);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/1999/02/22-rdf-syntax-ns#type")
				.withValue("http://www.w3.org/1999/02/22-rdf-syntax-ns#Bag");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code").withValue("00001");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#foo")
				.withValue("foo value 1");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#code").withValue("00002");
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#foo")
				.withValue("foo value 2");

		// Assert - Relationships
		var parentSubject = getStatement(model, "http://www.w3.org/2001/asio-rdf/3.0#code", "00003").getSubject();
		var parentSimpleCvnBeansValue = getStatement(model, parentSubject,
				"http://www.w3.org/2001/asio-rdf/3.0#simpleCvnBeans").getResource();

		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#simpleCvnBeans")
				.withSubjectNode(parentSubject).hasStatementsSize(1);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/2001/asio-rdf/3.0#simpleCvnBeans")
				.withSubjectNode(parentSimpleCvnBeansValue).hasStatementsSize(2);
		ModelAssert.assertThat(model).containsPredicate("http://www.w3.org/1999/02/22-rdf-syntax-ns#type")
				.withSubjectNode(parentSimpleCvnBeansValue).hasStatementsSize(1);
	}

	@Test
	public void whenCreateResourceOf_CvnBeanWithEmptyCollectionOfSimpleCvnBean_thenGenerateRdf()
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		// Arrange
		CvnBeanWithCvnBeanCollectionDummy cvnBeanWithCvnBeanCollection = new CvnBeanWithCvnBeanCollectionDummy();
	...
	@Test
	public void CvnRootBeanToRdf_ApprovalTest()
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	...
	private static Statement getStatement(Model model, String propertyName, String propertyValue) {
		return model.listStatements().toList().stream()
				.filter((st) -> st.getPredicate().toString().contains(propertyName)
						&& st.getObject().toString().equals(propertyValue))
				.findFirst().get();
	}

	private static Statement getStatement(Model model, String propertyName) {
		return model.listStatements().toList().stream()
				.filter((st) -> st.getPredicate().toString().contains(propertyName)).findFirst().get();
	}

	private static Statement getStatement(Model model, Resource subject, String propertyName) {
		return model.listStatements().toList().stream()
				.filter((st) -> st.getSubject().equals(subject) && st.getPredicate().toString().contains(propertyName))
				.findFirst().get();
	}
